...
FULL SCREEN MODE: http://albertusndaru/Lab_UGM_2/assets/img/error/404.html
...
.bg-purple{
    background: url(http://albertusndaru/Lab_UGM_2/assets/img/error/bg_purple.png) !important;
...
.stars{
    background: url(http://albertusndaru/Lab_UGM_2/assets/img/error/overlay_stars.svg);
