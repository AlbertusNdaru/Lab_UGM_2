...
<head>
    ...
    <!-- The styles -->
    <!-- <link href="<?= base_url('assets/')?>css/bootstrap-darkly.min.css" rel="stylesheet"> -->
    ...
    <!-- The fav icon -->
    <link rel="shortcut icon" href="<?= base_url('assets/')?>img/logo20.png">
...
<body class="bg-purple">
    ...
    <div class="navbar navbar-default  navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html"> <img alt="Charisma Logo" src="<?= base_url('assets/')?>img/logo20.png" class="hidden-xs"/>
