...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="green" data-background-color="black" data-image="<?= base_url()?>assets/img/sidebar-1.jpg">
      <!--
  ...
  <script src="<?= base_url()?>assets/demo/sharrre.js"></script>
  <script>
