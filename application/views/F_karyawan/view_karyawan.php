                    ...
                    <tr>
                        ...
                        <?php if ($_SESSION['Admin']->Usergroup_id == 1) {?>
                            <?php if ($k->Status == "Tidak Aktif") {?>
                                <a class="btn btn-success" style="width: 94px;" href="<?= base_url('M_karyawan/M_karyawan/editStatusKaryawan?id='.$k->Id.'&status=Aktif')?>">
                                    <i class="glyphicon glyphicon-ok icon-white"></i>
                                    Aprrove
                            <?php } else {?>
                                <a class="btn btn-danger" style="width: 94px;" href="<?= base_url('M_karyawan/M_karyawan/editStatusKaryawan?id='.$k->Id.'&status=Tidak Aktif')?>">
                                        <i class="glyphicon glyphicon-remove icon-white"></i>
                                    Reject
                            <?php }?>
                                </a>
                        <?php }?>
                            <a class="btn btn-info" href="<?= base_url('M_karyawan/M_karyawan/viewFormEditKaryawan?id='.$k->Id.'')?>">
                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                Edit
                            </a>
                            <a class="btn btn-danger" href="<?= base_url('M_karyawan/M_karyawan/deleteKaryawan?id='.$k->Id.'')?>">
